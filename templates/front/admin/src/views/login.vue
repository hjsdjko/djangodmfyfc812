<template>
  <div>
    ...
    <div class="container" :style='{"minHeight":"100vh","alignItems":"center","background":"url(http://codegen.caihongy.cn/20210307/d09089cb94194cdfb0a53c2edeb87136.jpg)","display":"flex","width":"100%","backgroundSize":"100% 100%","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"center"}'>
      <el-form :style='{"border":"0px solid #f6f6f6","padding":"40px 100px 40px","boxShadow":"-15px 15px 15px rgb(6 17 47 / 70%)","margin":"0 auto","alignItems":"flex-start","textAlign":"center","display":"flex","minHeight":"450px","borderRadius":"0","flexWrap":"wrap","background":"linear-gradient(230deg, rgba(53, 57, 74, 0) 0%, rgb(0, 0, 0) 100%)","width":"500px","fontSize":"14px","height":"auto"}'>
        <div v-if="true" :style='{"padding":"0px","margin":"0 0 20px","borderColor":"#ddd","color":"#D3D7F7","textAlign":"left","display":"inline-block","background":"none","borderWidth":"0px","width":"86%","lineHeight":"30px","fontSize":"16px","borderStyle":"solid","fontWeight":"500"}' class="title-container">基于Python的智能停车系统的设计与实现登录</div>
