...
<div class="center-preview" :style='{"padding":"0 7%","margin":"20px auto 40px","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","position":"relative","justifyContent":"space-between"}'>
	...
	<div class="info" :style='{"padding":"0","boxShadow":"0 0px 0px rgba(0, 0, 0, 0.3)","margin":"20px 0 0","borderColor":"#28890b20","alignItems":"center","display":"block","justifyContent":"center","borderRadius":"0px","flexWrap":"wrap","background":"#fff","borderWidth":"0px","width":"250px","position":"relative","borderStyle":"solid","height":"auto","order":"3"}'>
		...
		<div :style='{"padding":"20px 0","borderColor":"#0062a530","margin":"0 0 10px","borderWidth":"1px 1px","width":"100%","fontSize":0,"borderStyle":"solid","height":"auto"}' v-if="userTableName=='chezhu'">
		...
		<div :style='{"padding":"0 0px","borderColor":"#f9eacc","margin":"0 0 0px 0","borderWidth":"0px","background":"none","display":"flex","width":"100%","lineHeight":"40px","borderStyle":"solid","height":"auto"}' v-if="userTableName=='chezhu'">
			<span class="icon iconfont icon-shouye-zhihui" :style='{"padding":"0 5px","fontSize":"14px","color":"#333","display":"none"}'></span>
			<div :style='{"margin":"0 10px 0 0","fontSize":"14px","color":"#333","display":"inline-block"}'>车主号</div>
			<div :style='{"color":"#999","textAlign":"left","fontSize":"14px"}'>{{sessionForm.chezhuhao}}</div>
		</div>
		<div :style='{"padding":"0 0px","borderColor":"#f9eacc","margin":"0 0 0px 0","borderWidth":"0px","background":"none","display":"flex","width":"100%","lineHeight":"40px","borderStyle":"solid","height":"auto"}' v-if="userTableName=='chezhu'">
			<span class="icon iconfont icon-shouye-zhihui" :style='{"padding":"0 5px","fontSize":"14px","color":"#333","display":"none"}'></span>
			<div :style='{"color":"#333","margin":"0 10px 0 0","fontSize":"14px"}'>车主姓名</div>
			<div :style='{"color":"#999","textAlign":"left","fontSize":"14px"}'>{{sessionForm.chezhuxingming}}</div>
		</div>
		<div :style='{"padding":"0 0px","borderColor":"#f9eacc","margin":"0 0 0px 0","borderWidth":"0px","background":"none","display":"flex","width":"100%","lineHeight":"40px","borderStyle":"solid","height":"auto"}' v-if="userTableName=='chezhu'">
			<span class="icon iconfont icon-shouye-zhihui" :style='{"padding":"0 5px","fontSize":"14px","color":"#333","display":"none"}'></span>
		...
		<div :style='{"padding":"0 0px","borderColor":"#f9eacc","margin":"0 0 0px 0","borderWidth":"0px","background":"none","display":"flex","width":"100%","lineHeight":"40px","borderStyle":"solid","height":"auto"}' v-if="userTableName=='chezhu'">
			<span class="icon iconfont icon-shouye-zhihui" :style='{"padding":"0 5px","fontSize":"14px","color":"#333","display":"none"}'></span>
			<div :style='{"color":"#333","margin":"0 10px 0 0","fontSize":"14px"}'>车牌号</div>
			<div :style='{"color":"#999","textAlign":"left","fontSize":"14px"}'>{{sessionForm.chepaihao}}</div>
		</div>
    ...
    <el-tabs tab-position="left" :style='{"width":"calc(100% - 300px)","margin":"20px 0 0","flexWrap":"wrap","background":"#fff","display":"flex","order":"1"}' @tab-click="handleClick">
      <el-tab-pane label="个人中心">
        <el-form class="center-preview-pv" ref="sessionForm" :model="sessionForm" :rules="rules" label-width="100px">
          <el-form-item :style='{"width":"auto","padding":"0px","margin":"0 0 40px","background":"#fff","display":"inline-block"}' v-if="userTableName=='chezhu'" label="车主号" prop="chezhuhao">
            <el-input v-model="sessionForm.chezhuhao" placeholder="车主号" readonly></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"auto","padding":"0px","margin":"0 0 40px","background":"#fff","display":"inline-block"}' v-if="userTableName=='chezhu'" label="车主姓名" prop="chezhuxingming">
            <el-input v-model="sessionForm.chezhuxingming" placeholder="车主姓名" ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"auto","padding":"0px","margin":"0 0 40px","background":"#fff","display":"inline-block"}' v-if="userTableName=='chezhu'" label="性别" prop="xingbie">
            <el-select v-model="sessionForm.xingbie" placeholder="请选择性别" >
              <el-option v-for="(item, index) in dynamicProp.xingbie" :key="index" :label="item" :value="item"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item :style='{"width":"auto","padding":"0px","margin":"0 0 40px","background":"#fff","display":"inline-block"}' v-if="userTableName=='chezhu'" label="年龄" prop="nianling">
            <el-input v-model="sessionForm.nianling" placeholder="年龄" ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"auto","padding":"0px","margin":"0 0 40px","background":"#fff","display":"inline-block"}' v-if="userTableName=='chezhu'" label="手机号码" prop="shoujihaoma">
            <el-input v-model="sessionForm.shoujihaoma" placeholder="手机号码" ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"auto","padding":"0px","margin":"0 0 40px","background":"#fff","display":"inline-block"}' v-if="userTableName=='chezhu'" label="车牌号" prop="chepaihao">
            <el-input v-model="sessionForm.chepaihao" placeholder="车牌号" ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"auto","padding":"0px","margin":"0 0 40px","background":"#fff","display":"inline-block"}' v-if="userTableName=='chezhu'" label="头像" prop="touxiang">
			<file-upload
			tip="点击上传头像"
			action="file/upload"
			:limit="1"
  ...
  export default {
    ...
    created() {
		...
		if ('chezhu' == this.userTableName) {
			this.$set(this.sessionForm, 'chezhuhao', null);
		}
		if ('chezhu' == this.userTableName) {
			this.$set(this.sessionForm, 'mima', null);
		}
		if ('chezhu' == this.userTableName) {
			this.$set(this.sessionForm, 'chezhuxingming', null);
		}
		if ('chezhu' == this.userTableName) {
		...
		if ('chezhu' == this.userTableName&&this.rules['chezhuhao']){
			this.rules['chezhuhao'].push({ required: true, message: '请输入车主号', trigger: 'blur' })
		}else if('chezhu' == this.userTableName&&!this.rules['chezhuhao']) {
			this.$set(this.rules, 'chezhuhao', [{ required: true, message: '请输入车主号', trigger: 'blur' }]);
		}
		...
		if ('chezhu' == this.userTableName&&this.rules['chezhuxingming']){
			this.rules['chezhuxingming'].push({ required: true, message: '请输入车主姓名', trigger: 'blur' })
		}else if('chezhu' == this.userTableName&&!this.rules['chezhuxingming']) {
			this.$set(this.rules, 'chezhuxingming', [{ required: true, message: '请输入车主姓名', trigger: 'blur' }]);
		}
		if ('chezhu' == this.userTableName) {
		...
		if ('chezhu' == this.userTableName&&this.rules['chepaihao']){
			this.rules['chepaihao'].push({ required: true, message: '请输入车牌号', trigger: 'blur' })
		}else if('chezhu' == this.userTableName&&!this.rules['chepaihao']) {
