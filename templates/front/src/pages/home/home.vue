...
<!-- 商品推荐 -->
<div id="animate_recommendcheweixinxi" class="recommend animate__animated" :style='{"padding":"40px 7% 40px","margin":"0 auto","borderColor":"#ddd","flexWrap":"wrap","background":"none","borderWidth":"0px 0","display":"flex","width":"100%","position":"relative","borderStyle":"solid","order":"2"}'>
    ...
    <div class="title" :style='{"width":"100%","margin":"0 auto","textAlign":"center","background":"url(http://codegen.caihongy.cn/20240117/e2da3af842f44f9f86c61d0ff295414d.png) no-repeat center center / 35%","height":"60px"}'>
		<span :style='{"padding":"0px 0 0","fontSize":"26px","lineHeight":"60px","color":"#454545","fontWeight":"600","display":"block"}'>车位信息推荐</span>
	</div>
		...
		<div v-if="cheweixinxiRecommend.length" :style='{"padding":"0","margin":"10px 0 0","flexWrap":"wrap","background":"none","display":"flex","width":"100%","height":"auto","order":"3"}' class="list list17 index-pv1">
		  <div v-for="item,index in cheweixinxiRecommend" :key="index"  @click="toDetail('cheweixinxiDetail', item)" :style='{"cursor":"pointer","width":"calc(25% - 20px)","margin":"0 20px 20px 0","position":"relative","background":"none","height":"auto"}' class="item">
				<img class="image" v-if="preHttp(item.cheweitupian)" :src="item.cheweitupian.split(',')[0]" alt="" />
				<img class="image" v-else :src="baseUrl + (item.cheweitupian?item.cheweitupian.split(',')[0]:'')" alt="" />
			<div class="content">
		      <div :style='{"lineHeight":"24px","fontSize":"14px","color":"#333","display":"none"}'>{{item.cheweixiangqing}}</div>

		      <div class="info">
				<div :style='{"overflow":"hidden","whiteSpace":"hidden","color":"#333","textAlign":"left","width":"100%","lineHeight":"1.3","fontSize":"16px","textOverflow":"ellipsis","fontWeight":"500"}' class="name ">车位编号:{{item.cheweibianhao}}</div>
				<div :style='{"overflow":"hidden","whiteSpace":"hidden","color":"#333","textAlign":"left","width":"100%","lineHeight":"1.3","fontSize":"16px","textOverflow":"ellipsis","fontWeight":"500"}' class="name ">{{item.cheweiweizhi}}</div>
				<div :style='{"overflow":"hidden","whiteSpace":"hidden","color":"#333","textAlign":"left","width":"100%","lineHeight":"1.3","fontSize":"16px","textOverflow":"ellipsis","fontWeight":"500"}' class="name ">每小时价:{{item.meixiaoshijia}}</div>
	...
	<div @click="moreBtn('cheweixinxi')" :style='{"border":"0px solid #eccc19","cursor":"pointer","padding":"0 20px","margin":"0","borderRadius":"20px","textAlign":"RIGHT","background":"none","display":"block","width":"100%","lineHeight":"32px"}'>
		<span :style='{"color":"#3389d7","fontSize":"22px"}'>MORE</span>
		<i :style='{"color":"#3389d7","fontSize":"22px","display":"inline-block"}' class="icon iconfont icon-jiantou25"></i>
	</div>
